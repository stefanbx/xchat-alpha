...
Working documents. Each one is an audit of what is actually true right now plus what to do about it,
in order — not a wish list. Where something is unmeasured or unverified they say so.

| | |
|---|---|
| [WHITEPAPER.md](WHITEPAPER.md) | the design, and an honest done-vs-building breakdown |
...
**Current focus: decentralization and anonymity.** Red packets, stickers and the rest of the
social-feature list are parked deliberately — see the end of PRIVACY-AND-DECENTRALIZATION.md.
